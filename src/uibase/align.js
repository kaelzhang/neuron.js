...
/**
 * @public
 * @param {DOMElement|KM.DOM|string} node DOMElement, or instance of Neuron DOM, or CSS Selector
 */
function Align(node){
	this._node = $(node).el(0);
...
Align.prototype = {
	...
	align: function(target, pos, options){
		...
		self._target = is_view_port ? document.documentElement : $(target).el(0);
...
/**
 ...
 - module align will be a constructor and a KM.Class extension
