...
exports.isBoolean = function(obj){
    return OP_toString.call(obj) === ['object Boolean'];
};


exports.isNumber = function(obj){
    return OP_toString.call(obj) === ['object Number'];
};


exports.isString = function(obj){
    return OP_toString.call(obj) === ['object String'];
};
...
function clone(o, filter, marked, cached, depth){
    ...
    switch(type(o)){
        ...
        case 'object':
            if( !( 'isPrototypeOf' in obj || is_array) ){
 ...
 * @param {Object} params
 */
exports.substitute = function(template, params){
