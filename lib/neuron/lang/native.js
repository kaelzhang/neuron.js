...
// Iteration methods -----------------------
    ...
    map: function(fn, thisObject){
        ...
        for (var i = 0, l = this.length; i < l; i++){
            if (i in this) ret[i] = fn.call(thisObject, this[i], i, this);
        }
        return ret;
    },
    ...
    some: function(fn, thisObject){
        for (var i = 0, l = this.length; i < l; i++){
            if ((i in this) && fn.call(thisObject, this[i], i, this)) return true;
        }
        return false;
    },
...
/**
 ...
 2012-09-21  Kael:
 - will no longer throw error if there're more than one parameters, according to ECMA.
