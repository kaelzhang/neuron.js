...
local.search = function(context, expression, append, first){
	...
	// Kael:	
	// FIXME: 
	//     - window also has 'Slick' property
	//     X - might ruin append
	// spec:
	// Slick.search(document, window)
		...
		// Kael:
		// change code naming for better understanding:
		first ? found.push(expression) : found = expression;
		return found;
	} else { // other junk
		return found;
	}
...
}).apply(/*<CommonJS>*/(typeof exports != 'undefined') ? exports : /*</CommonJS>*/NR);
