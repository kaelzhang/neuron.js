 ...
 * unlike mootools
    - new NR.Class will return a pure javascript constructor
    - new NR.Class could inherit from a pure javascript constructor
 */
...
/**
 * @param {function()|Object} NR.Class instance or prototype of NR.Class instance
...
function _Class(base, proto, attrs){
    ...
    //      because it will be clear and less of further problems to declare attributes during the creation of new class.
...
/**
 ...
 2012-10-17  Kael:
 - attributes will always be initialized during the creation of new class
