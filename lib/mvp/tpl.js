...
function parse(template){
    return compile(
        template.replace(REGEX_REMOVE_SINGLE_LINE_COMMENTS, EMPTY)
                .replace(REGEX_CRLF, EMPTY)
    );
...
exports.REGEX_JSTL_SCOPE = REGEX_JSTL_SCOPE;
exports.CODE_PRE = '<?js';
exports.PARAM_PRE = '@{';
...
/**
 ...
 - will remove single line comments before parsing, fixes #3
