...
// Encapsulation for loader core especially for the situation
// that we load the configurations in a synchronous way, such as using inline scripts
...
loader.on('provide', function(mod) {
